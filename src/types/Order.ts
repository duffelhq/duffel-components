...
import { AirlineInitiatedChange } from "./AirlineInitiatedChange";
import {
  CabinClass,
...
export interface OrderService {
   ...
   */
  metadata?: OrderServiceBaggageMetadata | OfferAvailableServiceSeatMetadata;
  /**
...
export interface OrderSegmentPassenger {
   ...
   */
  seat?: OfferAvailableServiceSeatMetadata;
}
